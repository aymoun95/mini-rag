...
class CohereProvider(LLMInterface):
    def __init__(
        ...
        default_input_max_output_tokens: int = 1000,
        default_generation_temperature: float = 0.1,
    ):

        self.api_key = api_key
        self.default_input_max_characters = default_input_max_characters
        self.default_input_max_output_tokens = default_input_max_output_tokens
    ...
    def set_generation_model(self, model_id: str):
        self.generation_mode_id = model_id
    ...
    def generate_text(
        ...
        if not self.generation_mode_id:
        ...
        max_output_tokens = (
            ...
            else self.default_input_max_output_tokens
        )
        temperature = (
